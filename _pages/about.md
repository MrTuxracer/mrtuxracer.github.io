...
* [youtube.com](https://www.youtube.com/watch?v=-A0S2AkCLFg) - Interview @ Live Recon with @nahamsec
* [hackerone.com](https://www.hackerone.com/blog/Live-hacking-Dropbox-Amsterdam-H1-3120) - Live Hacking in Amsterdam
...
with vendors of all kinds. I think that especially the open source community, which is not backed up by a multi-billion 
dollar industry, deserves the free contribution of vulnerability information. Whenever possible, I'll therefore try to 
follow my [disclosure policy](https://www.rcesecurity.com/disclosure-policy/).

### Lorem Ipsum

If you like to contribute something: **info [a.t] rcesecurity [d.o.t] com**

For an additional level of privacy: [PGP-Key]({{ site.baseurl }}/pubkey.asc).
